...
| **Planning item** | yoke-project/yoke-sdk-go#4 |

## yoke-sdk-go:continuous-integration.01 — every proposed change runs the verbs, and nothing else does work
...
## yoke-sdk-go:continuous-integration.02 — what a run needs is declared, not taken from the runner
